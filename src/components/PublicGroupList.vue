                    ...
                    <div v-if="!isGroupCollapsed(group.element)" class="shadow-box monitor-list mt-4 position-relative">
                        ...
                        >
                            <template #item="monitor">
                                <div class="item px-4 px-md-5 py-4" data-testid="monitor">
                                    <div class="row">
                                        <div class="col-12 mb-3 d-flex justify-content-between align-items-center">
                                            <div class="info d-flex align-items-center">
                                                ...
                                                <a
                                                    ...
                                                    class="item-name fw-bold ms-2 text-decoration-none"
                                                    target="_blank"
                                                ...
                                                <p v-else class="item-name fw-bold ms-2 mb-0" data-testid="monitor-name">
                                                    {{ monitor.element.name }}
                                                </p>
                                            </div>
                                            <div class="uptime-text" style="color: #10b981; font-size: 0.85em; font-weight: 600;">
                                                <Uptime :monitor="monitor.element" type="24" :pill="false" /> uptime
                                            </div>
                                        </div>
                                        <div class="col-12" v-if="(showCertificateExpiry && monitor.element.certExpiryDaysRemaining) || showTags">
                                        ...
                                        <div :key="$root.userHeartbeatBar" class="col-12">
                                            <HeartbeatBar size="mid" :monitor-id="monitor.element.id" :heartbeat-bar-days="90" />
                                        </div>
                                    </div>
                                </div>
                            </template>
