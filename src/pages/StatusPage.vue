<template>
    <div v-if="loadedTheme" class="container status-page-container mt-3">
        ...
        <div :class="{ edit: enableEditMode }" class="main">
            ...
            <!-- Overall Status -->
            <div class="overall-status mb-5 text-center">
                <div v-if="Object.keys($root.publicMonitorList).length === 0 && loadedData" class="d-flex flex-column align-items-center">
                    <font-awesome-icon icon="question-circle" class="ok mb-3" style="font-size: 3rem;" />
                    <h2 class="fw-bold">{{ $t("No Services") }}</h2>
                </div>

                <template v-else>
                    <div v-if="allUp" class="d-flex flex-column align-items-center">
                        <font-awesome-icon icon="check-circle" class="ok mb-3" style="font-size: 3rem;" />
                        <h2 class="fw-bold">All services are online</h2>
                    </div>

                    <div v-else-if="partialDown" class="d-flex flex-column align-items-center">
                        <font-awesome-icon icon="exclamation-circle" class="warning mb-3" style="font-size: 3rem;" />
                        <h2 class="fw-bold">{{ $t("Partially Degraded Service") }}</h2>
                    </div>

                    <div v-else-if="allDown" class="d-flex flex-column align-items-center">
                        <font-awesome-icon icon="times-circle" class="danger mb-3" style="font-size: 3rem;" />
                        <h2 class="fw-bold">{{ $t("Degraded Service") }}</h2>
                    </div>

                    <div v-else-if="isMaintenance" class="d-flex flex-column align-items-center">
                        <font-awesome-icon icon="wrench" class="status-maintenance mb-3" style="font-size: 3rem;" />
                        <h2 class="fw-bold">{{ $t("maintenanceStatus-under-maintenance") }}</h2>
                    </div>

                    <div v-else class="d-flex flex-column align-items-center">
                        <font-awesome-icon icon="question-circle" style="color: #efefef; font-size: 3rem;" />
                    </div>
                </template>
            </div>
